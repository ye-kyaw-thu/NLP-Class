...
အသံဖိုင်တွေမှာ တကယ်က လှိုင်းပုံစံနဲ့တောက်လျှောက်ဖြစ်နေတာမို့ အတက်အကျ ဖြစ်ပေါ်နေတဲ့ ပုံစံ ရှိပါတယ်။ waveform ရဲ့ တက်လိုက်ကျလိုက် ဖြစ်နေတဲ့ pattern တွေကို ဆိုလိုတာပါ။ အောက်မှာ ပြထားတဲ့ Sine wave ပုံကို အာရုံစိုက်ပြီး ကြည့်ကြည့်ပါ zero level ကို သတ်မှတ်ထားတဲ့ မျဉ်းကြောင်းက ရှိနေပြီး Sine wave ရဲ့ လှိုင်းက zero ပွိုင့် ကနေ အပေါင်းတန်ဖိုးတွေနဲ့ အပေါ်ဖက်ကို တက်လာပြီး peak တနေရာရာကို ရောက်တဲ့ အခါမှာ ပြန်ဆင်းလာပြီး zero ကို ဖြတ်သွားပြီး အနှုတ်ဖက်အခြမ်းကို ဆင်းကျသွားပါတယ်။ အနှုတ်တန်ဖိုး တနေရာရာကို ရောက်သွားတဲ့ အခါမှာ တန်ဖိုးတွေက ပြန်တက်လာပြီး zero ပွိုင့်ကို နောက်တစ်ခေါက် ထပ်ဖြတ်ပါမယ်။ ပြီးရင် တဖြည်းဖြည်းနဲ့ အပေါင်းဖက်မှာ လှိုင်းက ပြန်တက်သွားပါလိမ့်မယ်။ အဲဒီပုံစံက Sine wave မှာဆိုရင် ငြိမ်နေတဲ့ wave pattern က ဆက်တိုက် ဖြစ်ပေါ်နေတာပါ။ အဲဒီ လှိုင်းရဲ့ zero ပွိုင့်ကို ဖြတ်တဲ့နေရာတွေကို "zero crossing" လို့ ခေါ်တာပါ။  
...
တကယ့် လက်တွေ့ အသံလှိုင်းတွေမှာတော့ Sine wave လိုမျိုး pattern က တိတိကျကျ ငြိမ်နေတာမျိုး မဟုတ်ပါဘူး။ အထူးသဖြင့် လူတွေရဲ့ စကားပြောတဲ့ အသံတွေမှာက pattern ပုံစံတစ်ခုကနေ နောက်တစ်ခုကို တဖြည်းဖြည်းချင်း ပြောင်းသွားတဲ့ ပုံစံပါ။ အဲဒီ pattern ပုံစံတွေကိုတော့ လူတွေရဲ့ စကားပြောတဲ့အသံတွေကို recording လုပ်ပြီး Praat ပရိုဂရမ်ကို သုံးပြီး waveform ပုံစံကို zoom in ကို ထပ်ခါထပ်ခါ လုပ်သွားပြီး ချဲကြည့်တဲ့အခါမှာ မြင်ရပါလိမ့်မယ်။ အောက်မှာ ပြထားတဲ့ ပုံက တရုပ်ကလေးငယ်ရဲ့ အူဝဲငိုသံကို zoom in ၅ခါလောက် လုပ်ပြီး ကြည့်ရတဲ့အခါမှာ မြင်ရတဲ့ wave pattern ပါ။ ဂရုစိုက်ကြည့်ရင် အတက်အကျ ပုံစံတစ်ခုက (i.e. wave pattern) ထပ်ခါထပ်ခါ ဖြစ်နေတာမျိုးကို မြင်ရပါလိမ့်မယ်။ နောက်ပြီးတော့ zero point မျဉ်းကြောင်းကိုလည်း ဖြတ်ပြီးတော့ တက်လိုက်၊ ဆင်းလိုက် ဖြစ်နေတာကို တွေ့ရပါလိမ့်မယ်။   

<p align="center">
<img src="https://github.com/ye-kyaw-thu/NLP-Class/blob/master/supplementary/Annotation-with-Praat/fig/Chinese-baby-selection1.png" alt="drawing" width="600"/>  
</p>  
<div align="center">
...
ကောင်းပြီ ဒီတစ်ခါတော့ အထက်ပါ ပုံရဲ့ selection မှတ်ထားတဲ့ အပိုင်းကိုပဲ focus လုပ်ပြီး ကြည့်ကြရအောင်။ selection ရဲ့ အစပိုင်းရဲ့ အမှတ်က "0.590070" မီလီစက္ကန့် ဖြစ်ပြီးတော့ selection ရဲ့ အဆုံးပိုင်းက "0.593001" မီလီစက္ကန့် ဖြစ်နေတာကို မှတ်ထားပေးပါ။ ပြီးတော့ selection ရဲ့ အစ အမှတ် အဆုံး အမှတ်တွေက တိတိကျကျ ပြောရမယ်ဆိုရင် zero crossing ဖြစ်နေတဲ့ နေရာမှာ ရှိနေကြတာ မဟုတ်ပါဘူး။ အဲဒီလို ဖြစ်နေတဲ့အတွက် sound pattern အနေနဲ့က ပြတ်တောက်နေတဲ့ သဘောရှိတာမို့ အဲဒီလို selection မှတ်ထားတဲ့ အပိုင်းကို တခြား အသံရဲ့ အစိတ်တပိုင်းတစ်ခုနဲ့ ပေါင်းတဲ့အခါမျိုးမှာ၊ တွဲပေးတဲ့အခါမျိုးမှာ (i.e. merge or append) အသံအကူးအပြောင်းက smooth မဖြစ်တော့ပါဘူး။ အဲဒီလို မဖြစ်အောင်ဆိုရင် selection မှတ်တဲ့အခါမှာ တတ်နိုင်သ၍ အစပိုင်းကိုကော၊ အဆုံးပိုင်းကိုကော zero crossing ဖြစ်တဲ့ ပွိုင့်ကနေ ယူလေ့ရှိပါတယ်။ အောက်မှာ ပြထားတဲ့ figure က အထက်က selection မှတ်ထားတဲ့ ပုံစံကနေ selection အစကို နီးစပ်တဲ့ zero crossing နေရာကို ရွှေ့လိုက်ရင် (ဘယ်ဘက်က ပုံ)၊ ထိုနည်းလည်းကောင်း selection နောက်ဆုံး အပိုင်းကို zero crossing နေရာကိုရွှေ့လိုက်ရင် selection point တွေရဲ့ မီလီစက္ကန့်တွေက ဘယ်လို ပြောင်းလဲ သွားမလဲ ဆိုတာကို အထက်က ပုံနဲ့ တွဲပြီး နှိုင်းယှဉ်လေ့လာနိုင်စေဖို့ ပြထားတာ ဖြစ်ပါတယ်။   
...
Praat ကို အသုံးပြုတဲ့အခါမှာ Menu တွေကိုပဲ သုံးပြီးအလုပ်လုပ်သွားတာထက် သိထားရင် အထောက်အကူဖြစ်မယ့် ကီးဘုတ် shortcut တချို့ကို မိတ်ဆက်ပေးပါမယ်။  
Basic operation နဲ့ transcript အလုပ်အတွက် အဓိက မှတ်သားထားစေချင်တဲ့ shortcut တွေပါ။  

- Selection မှတ်ထားတဲ့ အသံအစိတ်အပိုင်းကို လက်ရှိ select မှတ်ထားတဲ့ Tier မှာ interval အဖြစ် (သို့) Boundary အဖြစ် သတ်မှတ်ချင်ရင် ```Enter```
- လက်ရှိ selection မှတ်ထားတဲ့ အသံအစိတ်အပိုင်းကိုပဲ Play လုပ်ချင်ရင် ```Tab```  
- လက်ရှိ Play လုပ်နေတာကို ရပ်လိုက်ချင်ရင် ```Escape```  
  (Long Sound ဖိုင်ကို Play လုပ်နေစဉ်မှာ သုံးတာများ)  
- Window မှာ မြင်နေရတဲ့ အပိုင်းကိုပဲ Play လုပ်ဖို့အတွက်က ```Shift+Tab```  
- လက်ရှိ selection မှတ်ထားတဲ့ အစပိုင်းလိုင်းကို ဘယ်ဘက်ကို ရွှေ့ချင်ရင် ```Shift+Up-Arrow```  
- လက်ရှိ selection မှတ်ထားတဲ့ အစပိုင်းလိုင်းကို ညာဘက်ကို ရွှေ့ချင်ရင် ```Shift+Down-Arrow```  
- လက်ရှိ selection မှတ်ထားတဲ့ နောက်ဆုံးပိုင်းလိုင်းကို ဘယ်ဘက်ကို ရွှေ့ချင်ရင် ```Ctrl+Up-Arrow```  
- လက်ရှိ selection မှတ်ထားတဲ့ နောက်ဆုံးပိုင်းလိုင်းကို ညာဘက်ကို ရွှေ့ချင်ရင် ```Ctrl+Down-Arrow```  
...
17. Will Styler, Using Praat for Linguistic Research, Link: https://wstyler.ucsd.edu/praat//
