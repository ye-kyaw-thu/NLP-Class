...
<div align="center">
  ...
  <span style="color:red"> အရေးကြီးတဲ့အချက်က လက်ရှိ tool အနေနဲ့က alignment လုပ်ပေးထားတာကို မှတ်ထားတဲ့ output ဖိုင်တွေက wordalignui/ ဖိုလ်ဒါအောက်မှာ ရှိနေမှာမို့ corpus အပြောင်းအလဲ လုပ်တဲ့အခါမှာ overwrite မလုပ်မိအောင် backup ကူးတာ ရွှေ့သိမ်းတာလုပ်ဖို့ကို မမေ့ပါနဲ့ </span>  
